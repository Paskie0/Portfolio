...
export default function Home() {
  return (
    <main className="max-w-screen-md mx-auto grid gap-8 px-4">
      <div className="grid gap-4 mt-8">
        ...
        />
        <h1 className="text-center text-3xl font-bold">Pascal de Wit</h1>
        <p className="text-center">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vitae modi dolorem inventore, repellendus ad facere?
        </p>
          ...
          <Button asChild variant="ghost" className="px-2 sm:px-4">
            <Link href="/" className="flex gap-2">
              <svg
                ...
                <path
                  fill="currentColor"
                  d="M714.163 519.284 1160.89 0h-105.86L667.137 450.887 357.328 0H0l468.492 681.821L0 1226.37h105.866l409.625-476.152 327.181 476.152H1200L714.137 519.284h.026ZM569.165 687.828l-47.468-67.894-377.686-540.24h162.604l304.797 435.991 47.468 67.894 396.2 566.721H892.476L569.165 687.854v-.026Z"></path>
              </svg>
